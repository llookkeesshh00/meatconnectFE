...
const SupplierTopNavbar = () => {
    return (
        ...
        <div className="topnavbar w-full bg-slapte-300 h-12 p-3 flex justify-between bg-gray-200 gap-8  pr-4">
            <div className='text-purple-900 text-xl font-bold'> Hey supplier !</div>
            <div className='item flex items-center gap-16 '>
