...
const HomePage = () => {
  return (
    <div>
      {/* Hero Section */}
      <section className="bg-cover bg-center h-[600px]" style={{ backgroundImage: `url(./assets/background.jpeg)` }}> {/* Dummy background image */}
        <div className="container mx-auto flex flex-col justify-center h-full text-center">
          <h1 className="text-white text-4xl font-bold">Meat Supply Connection Farm</h1>
          <p className="text-white mt-4">Connecting farms with reliable meat supply partners.</p>
        ...
        <div className="container mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-4 shadow-md">
              <img src="https://via.placeholder.com/150" alt="Explore Contracts" className="mx-auto mb-4" /> {/* Dummy image */}
            ...
            <div className="bg-white p-4 shadow-md">
              <img src="https://via.placeholder.com/150" alt="Select Contract" className="mx-auto mb-4" /> {/* Dummy image */}
            ...
            <div className="bg-white p-4 shadow-md">
              <img src="https://via.placeholder.com/150" alt="Take Delivery" className="mx-auto mb-4" /> {/* Dummy image */}
