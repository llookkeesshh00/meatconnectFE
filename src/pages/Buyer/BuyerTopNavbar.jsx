...
const BuyerTopNavbar = () => {
  return (
       ...
       <div className="topnavbar w-full bg-slapte-300 h-12 p-1 bg-gray-200 flex justify-end gap-8  pr-4">
            ...
            <div className="seachbar flex items-center">
                <input type="text" name="search" id="" width={600} className='rounded-lg p-1' placeholder='search your requirements' />
            </div>
            <div className="item flex items-center gap-1">
