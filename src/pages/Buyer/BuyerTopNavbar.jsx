...
const BuyerTopNavbar = () => {
    ...
    return (
        ...
        <div className="topnavbar w-full bg-slapte-300 h-12 p-3 bg-gray-200 flex justify-between gap-8  pr-4">
            <div className='text-purple-900 text-xl font-bold'> Hey Buyer !</div>
            <div className='flex gap-10 '> 
                <div className="item flex items-center gap-1" onClick={() => navigate('/buyer/buyerHome')}>
                    ...
                    <div className="text font-semibold text-purple-500"> dashboard </div>
                </div>
                <div className="item flex items-center gap-1" >
                    ...
                    <div className="text font-semibold text-purple-500"> profile </div>
                </div>

                <div className="seachbar flex items-center ">
                    <input type="text" name="search" id="" style={{width:'400px'}} className='rounded-lg p-1' placeholder='search your requirements' />
                </div>
                <div className="item flex items-center gap-1">
                    ...
                    <div className="text font-semibold text-purple-500"> logout </div>
                </div>
