...
const BuyerTopNavbar = () => {
  ...
  return (
    <div className="topnavbar w-full  h-12 p-3 bg-gray-100 flex justify-between gap-8 pr-4">
      ...
      <div className="flex gap-10">
        ...
        {/* Profile link with dynamic user name */}
        <div className="item flex items-center gap-1 transition-transform transform hover:scale-105 hover:shadow-md hover:bg-purple-50 p-2 rounded-md cursor-pointer">
          <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#000000">
