        ...
        <div className="container bg-purple-00 min-h-[100vh] flex flex-col w-1/4 p-2 border-r-2 border-purple-300">
            <div className="p-2 flex flex-col gap-3">
                <div onClick={() => { navigate('/buyer/buyerhome') }} 
                 className={path==='/buyer/buyerhome'?"item flex gap-6 p-2 bg-purple-200 rounded-lg shadow-md transition duration-300":"item flex gap-6 p-2 hover:bg-purple-200 hover:rounded-lg hover:shadow-md transition duration-300"}>
                ...
                <div onClick={() => { navigate('/buyercontracts') }}
                  className={path==='/buyercontracts'?"item flex gap-6 p-2 bg-purple-200 rounded-lg shadow-md transition duration-300":"item flex gap-6 p-2 hover:bg-purple-200 hover:rounded-lg hover:shadow-md transition duration-300"}>
                ...
                className={path==='/buyertracking'?"item flex gap-6 p-2 bg-purple-200 rounded-lg shadow-md transition duration-300":"item flex gap-6 p-2 hover:bg-purple-200 hover:rounded-lg hover:shadow-md transition duration-300"}>
                ...
                {/* <div onClick={() => { navigate('/buyernotifications') }} 
                 className={path==='/buyernotifications'?"item flex gap-6 p-2 bg-purple-200 rounded-lg shadow-md transition duration-300":"item flex gap-6 p-2 hover:bg-purple-200 hover:rounded-lg hover:shadow-md transition duration-300"}>
               ...
               className={path==='/buyersummary'?"item flex gap-6 p-2 bg-purple-200 rounded-lg shadow-md transition duration-300":"item flex gap-6 p-2 hover:bg-purple-200 hover:rounded-lg hover:shadow-md transition duration-300"}>
                    <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#000000"><path d="M320-600q17 0 28.5-11.5T360-640q0-17-11.5-28.5T320-680q-17 0-28.5 11.5T280-640q0 17 11.5 28.5T320-600Zm0 160q17 0 28.5-11.5T360-480q0-17-11.5-28.5T320-520q-17 0-28.5 11.5T280-480q0 17 11.5 28.5T320-440Zm0 160q17 0 28.5-11.5T360-320q0-17-11.5-28.5T320-360q-17 0-28.5 11.5T280-320q0 17 11.5 28.5T320-280ZM200-120q-33 0-56.5-23.5T120-200v-560q0-33 23.5-56.5T200-840h440l200 200v440q0 33-23.5 56.5T760-120H200Zm0-80h560v-400H600v-160H200v560Zm0-560v160-160 560-560Z" /></svg>
                    <div className="text font-semibold text-purple-500">summary</div>
                </div>
                <div onClick={() => { navigate('/buyeraddresses') }} 
                className={path==='/buyeraddresses'?"item flex gap-6 p-2 bg-purple-200 rounded-lg shadow-md transition duration-300":"item flex gap-6 p-2 hover:bg-purple-200 hover:rounded-lg hover:shadow-md transition duration-300"}>
