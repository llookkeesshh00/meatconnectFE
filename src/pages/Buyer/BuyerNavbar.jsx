...
const BuyerNavbar = () => {
    ...
    return (
    <div className="condtainer bg-purple-00 min-h-[100vh] flex flex-col w-1/4 p-2  border-r-2 border-purple-300">
        <div className="p-2 flex flex-col gap-3 ">
            <div  onClick={()=>{navigate('/buyercontracts')}}  className="item  flex gap-6 p-2  hover:bg-purple-200  hover:rounded-lg mt-10 ">
            ...
            <div onClick={()=>{navigate('/buyertracking')}}  className="item  flex gap-6 p-2 hover:bg-purple-200  hover:rounded-lg">
            ...
            <div onClick={()=>{navigate('/buyernotifications')}}   className="item  flex gap-6 p-2  hover:bg-purple-200  hover:rounded-lg">
            ...
            <div onClick={()=>{navigate('/buyerhelp')}}   className="item  flex gap-6  p-2 hover:bg-purple-200  hover:rounded-lg">
